...
public class ARactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashMap.put("pizza",new ARProductData(R.raw.pizza,0.59f,0.6f));
        hashMap.put("noodles",new ARProductData(R.raw.noodles,0.59f,0.6f));
        hashMap.put("burger",new ARProductData(R.raw.burger,0.59f,0.6f));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ARactivity.this, Menu.class);
